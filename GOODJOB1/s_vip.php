 <section class="ftco-section bg-light" id="blog-section" style="position:relative; margin-top:-96px;">
      ...
      <div class="col-md-12" style="height:50px;"> <b> SUPER VIP განცხადებები </b> </div>
...
$tbl_name="login";		//your table name
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name WHERE s_vip>".time().""; 
	$total_pages = mysqli_fetch_array(mysqli_query($conn, $query));
	$total_pages = $total_pages['num'];
	
	/* Setup vars for query. */
	$targetpage = "index.php?do=s_vip"; 	//your file name  (the name of this file)
	...
	$sql = "SELECT * FROM $tbl_name WHERE s_vip>".time().""; 
