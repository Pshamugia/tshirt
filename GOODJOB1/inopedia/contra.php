<div class="title">
			  ...
			  <ul class="tabNavigation">
				   <li><a class="" href=""><span><span><b>PO & CONTRA</b></span></span></a></li>
...
<tr> <?php
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name where kategory='procontra'";
	$total_pages = mysql_fetch_array(mysql_query($query));
	$total_pages = $total_pages['num'];
	
	/* Setup vars for query. */
	$targetpage = "index.php?do=contra"; 	//your file name  (the name of this file)
	...
	$sql = "SELECT * FROM $tbl_name where kategory='procontra' order by id desc LIMIT $start, $limit";
