...
-->
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
							...
							<a class="nav-link" href="index.php?do=trade"><div class="sb-nav-link-icon"><i class="fas fa-battery-half"></i></div>
                              ტრანზაქციები </a>
							<? 
	 ...
	 if ($_SESSION['hide_admins']!='1') 
 {
	 ...
	 echo "";
							...
							<a class="nav-link" href="index.php?do=kalaki" ><div class="sb-nav-link-icon"><i class="fas fa-envelope"></i></div>
                              ქალაქი </a>
							<a class="nav-link" href="index.php?do=ubani" ><div class="sb-nav-link-icon"><i class="fas fa-envelope"></i></div>
                              უბანი </a>
							...
							<a class="nav-link" href="http://webmail.teachershub.ge/" target="_blank"><div class="sb-nav-link-icon"><i class="fas fa-envelope"></i></div>
                               ელფოსტა </a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid" style="height:auto">
						...
						mysqli_query($conn, "UPDATE login set editor='0' WHERE editor=$_SESSION[sesia]");
