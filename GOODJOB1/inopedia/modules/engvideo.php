...
<?php
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name where kategory='ვიდეო' AND eng_geo='Eng'";
	...
	$sql = "SELECT * FROM $tbl_name where kategory='ვიდეო' AND eng_geo='Eng' order by id desc LIMIT $start, $limit";
...
<a href="index.php?do=engupdatevideo&id=<? echo $b['id']; ?>"><img src="images/edit-icon.png" width="20" 
...
<textarea  name="satauri" cols="70" rows="2" style="border-radius: 5px; 
-moz-border-radius: 5px; 
-webkit-border-radius: 5px; 
border: 1px solid #999; " ></textarea> <div style="position:relative; top:-90px; left: 590px">  </div> 
...
-moz-border-radius: 5px; 
-webkit-border-radius: 5px; 
border: 1px solid #999; background-color:transparent;" value="SUBMIT"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
