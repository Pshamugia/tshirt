...
$sql="insert into login (username, kategory, upload, avtori, agwera, full, date, news_date, menu, view_count, hidden) VALUES('$_REQUEST[username]', '$kategory', '$b[0]', '$_REQUEST[avtori]', '$_REQUEST[agwera]', '$_REQUEST[full]', '$date', '".strtotime($_REQUEST[news_date])."', '$_REQUEST[menu]',  '".intval($_REQUEST[view_count])."',  '".intval($_REQUEST[hidden])."')";
