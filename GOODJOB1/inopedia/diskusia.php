...
<div class="title">
			  ...
			  <ul class="tabNavigation">
				   <li><a class="" href=""><span><span><b>მრგვალი მაგიდა </b></span></span></a></li>
...
<tr> <?php
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name where kategory='დისკუსია'";
	$total_pages = mysql_fetch_array(mysql_query($query));
	$total_pages = $total_pages['num'];
	
	/* Setup vars for query. */
	$targetpage = "index.php?do=diskusia"; 	//your file name  (the name of this file)
	...
	$sql = "SELECT * FROM $tbl_name where kategory='დისკუსია' order by id desc LIMIT $start, $limit";
...
while ($b=mysql_fetch_array($a))
{
 ...
 <div style="background:#CCCCCC; width:130px"><font size="-1" class="front_text"><b> <? echo $b['kategory']; ?> </b> </font></div> 
 
 
<a href="<? echo $b['upload'];?>" rel="lightbox" title="demo.ge">  <img src="<? echo $b['upload'];?>" width="130"  height="130" align="left" style="margin-right:6px; background:#CCCCCC" rel="lightbox" title="დააკლიკე">  </a>
  
  <div align="left"  style="margin-left:6px" id="linkebi"><b> 
  <a href="index.php?do=full&id=<? echo $b['id'];?>"> <? echo $b['satauri'] ; ?>    </a></b> </div>
...
<div style="margin:4px; margin-left:6"> <i style="font-size:14px"> <?	echo $avts_id['avtori']; ?> 
	
	

  || <? echo $b['date']; ?>   </i> <br /></div>
...
<a href="index.php?do=full&id=<? echo $b['id'];?>" id="gverditi"> <span class="style1">კომენტარები</span>     <? echo "|". $com."|"; ?>      </a> &nbsp;&nbsp;     </font>   </div> 
 <? 
