...
<h2 style="position:relative; top:12px; left:0px;"> <div style="position:relative; margin-left:25px; height:20px; margin-top:1px; border-left:5px solid #2E3333; font-weight:100; font-size:20px;">  <k style="position:relative; padding-left:15px;"> ბლოგები </k>  </b> </div> </h2>
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name where kategory='ბლოგები' AND eng_geo='Geo'";
	...
	$sql = "SELECT * FROM $tbl_name where kategory='ბლოგები' AND eng_geo='Geo' order by news_date desc LIMIT $start, $limit";
