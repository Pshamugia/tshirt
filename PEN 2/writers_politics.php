...
<td valign="top"> 
 <h2 style="position:relative; top:10px;  padding-bottom:15px; "> <div style="position:relative;height:20px; margin-top:1px; border-left:5px solid #2E3333; font-weight:100; font-size:20px; ">  <k style="position:relative; padding-left:15px; "> მწერლები სოციალური და პოლიტიკური პრობლემების შესახებ </k>  </b> </div> </h2> 
   
   
      <div style="position:relative; padding-bottom:50px; font-size:14px; padding-top:px; width:350px;" align="left">  <strong>  </strong> "მწერლები სოციალური და პოლიტიკური პრობლემების შესახებ" საქართველოს პენცენტრის პროექტია. ამ პროექტით შევეცდებით, მწერლების ხმა საზოგადოების უფრო ვრცელ ნაწილს მივაწვდინოთ, ავსახოთ არსებული პრობლემები და ვიფიქროთ მათი გადაწყვეტის გზებზე. <br>
      პროექტის პარტნიორია საქართველოს მწერალთა სახლი.
<br><br>
  </div>    
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name where kategory='ბლოგები' AND eng_geo='Geo' OR tags LIKE '%,მწერლები სოციალური პრობლემების შესახებ%' ";
	...
	$sql = "SELECT * FROM $tbl_name where kategory='ბლოგები' AND eng_geo='Geo' OR tags LIKE '%,მწერლები სოციალური პრობლემების შესახებ%' order by news_date desc LIMIT $start, $limit";
