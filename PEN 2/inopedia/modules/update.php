...
mysqli_query($conn, "UPDATE kultura_cxrili set editor='$_SESSION[sesia]' WHERE id=$_REQUEST[id]");
...
$kategoryString = implode('|', $_REQUEST['kategory']);

// Use the string in the SQL query
$sql = "UPDATE kultura_cxrili 
        SET kategory='$kategoryString', 
            subkat='$_REQUEST[subkat]', 
            tags_geo='$_REQUEST[tags_geo]', 
            tags_eng='$_REQUEST[tags_eng]', 
            upload='$b', 
            eng_geo='$_REQUEST[eng_geo]', 
            img_description='$_REQUEST[img_description]', 
            satauri_ka='$_REQUEST[satauri_ka]', 
            satauri_en='$_REQUEST[satauri_en]', 
            avtori='$_REQUEST[avtori]', 
            avtori2='$_REQUEST[avtori2]', 
            agwera_ka='$_REQUEST[agwera_ka]', 
            agwera_en='$_REQUEST[agwera_en]', 
            full_ka='$_REQUEST[full_ka]', 
            full_en='$_REQUEST[full_en]', 
            ena='$_REQUEST[ena]', 
            menu='$_REQUEST[menu]', 
...
<br>
     <textarea name="agwera_ka" cols="85" rows="5" id="new_editor"> <? echo $data['agwera_ka']; ?></textarea>
...
//-->
 ...
 <textarea name="full_ka" cols="85" rows="5"> <? echo $data['full_ka']; ?></textarea>
