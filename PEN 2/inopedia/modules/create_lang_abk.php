<div id="Abkhazian" class="tabcontent">
...
$data=mysqli_fetch_array($r); ?>
  ...
  <br />
          ...
          <p>
            ...
            <input type="text" name="news_dateRUS" value="კალენდარი" id="news_dateRUS" style="font-family:Gotham, 'Helvetica Neue', Helvetica, Arial, sans-serif; width:320px; height:35px; padding-bottom:15px; background-color:#F0F0F0; top:12px; z-index:101;"  / >  
 ...
 საათი და წუთი <br>
        ...
        <input type="text" name="hourRUS" id="hourRUS" value="<?php date_default_timezone_set('UTC+04:00/Tbilisi');
 ...
 <script type="text/javascript"> function existingTagRUS(text)
...
$(function(){
  ...
  $("#tags-new_RUS input").focus();



  $("#tags-new_RUS input").keyup(function(){
...

		{
			...
			if(!existingTagRUS(tag))

			{

				$('<li class="tags" id="tags_RUS"><span>' + tag + '</span><i class="fa fa-times"></i> </li>').insertBefore($("#tags-new_RUS"));

				$('#save_tags_RUS').val($('#save_tags_RUS').val() + "," + tag)
  ...
  $(document).on("click", "#tags_RUS svg", function(){

	  var text = $(this).parent().text();

	  var tags_str = $('#save_tags_RUS').val();

	  tags_str = tags_str.replace(','+text, '');

	  $('#save_tags_RUS').val(tags_str);
 ...
 <span id="wrapper">
  ...
  <link href="//netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css" rel="stylesheet">
   ...
   <ul class="tags-input" id="tags-input_RUS"  style="height:auto; width:750px;">

    <li class="tags" id="tags_RUS" style="background-color:#B9B8B8; color:#000000;">TAGS <i class="fa fa-times"></i></li>

	<?

		$tags = explode(',', $data['tags_RUS']);
	...
	<li class="tags" id="tags_RUS"><?=$tag?><i class="fa fa-times"></i></li>
    ...
    <li class="tags-new" id="tags-new_RUS" style="color:#D70003;">

      <input type="text" id="tags_RUS">

	  <input type="hidden" name="tags_RUS" id="save_tags_RUS" value="<?=$data['tags_RUS']?>"/>
...
<textarea  name="satauri_ru" style=" background-color:#FFFFFF; width:100%; "  placeholder="სათაური"></textarea> 
...
<textarea  name="agwera_ab" id="agwera_ab" cols="70" rows="5" >&nbsp;</textarea>

 <script type="text/javascript">

CKEDITOR.replace('agwera_ab');

</script> 



<textarea name="full_ab" id="full_ab" cols="70" rows="12">  </textarea>



<script type="text/javascript">

CKEDITOR.replace('full_ab');
