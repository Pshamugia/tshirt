...
function sendEmail($email, $subject, $message)
{
	...
	$mail->From = "info@geonova.ge";
	$mail->FromName = "geonova";
...
{
	$link = "https://geonova.ge/index.php?do=full&id=".intval($_GET['send_email']);
...
<?php
	...
	*/
	...
	$query = "SELECT COUNT(*) as num FROM $tbl_name WHERE kategory!='ფოტო' AND kategory!='ვიდეო|' AND kategory!='images' $W";
	...
	$sql = "SELECT * FROM $tbl_name WHERE kategory!='ფოტო' AND kategory!='ვიდეო|' AND kategory!='images'  $W order by id desc LIMIT $start, $limit";
