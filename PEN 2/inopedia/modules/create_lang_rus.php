...
<textarea  name="agwera_ru" id="agweraRUS" cols="70" rows="5" >&nbsp;</textarea>

 <script type="text/javascript">

CKEDITOR.replace('agwera_ru');

</script> 



<textarea name="full_ru" id="full_ru" cols="70" rows="12">  </textarea>



<script type="text/javascript">

CKEDITOR.replace('full_ru');
