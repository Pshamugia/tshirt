...
<tr>
<td valign="top"> 
<h2 style="position:relative; top:12px; left:76px;"> <div style="position:relative; margin-left:25px; height:20px; margin-top:1px; border-left:5px solid #2E3333; font-weight:100; font-size:20px;">  <k style="position:relative; padding-left:15px;"> დარიო რადიო </k>  </b> </div> </h2>
