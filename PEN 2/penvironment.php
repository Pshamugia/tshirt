...
<td valign="top"> 
 <h2 style="position:relative; top:10px;  padding-bottom:15px; "> <div style="position:relative;height:20px; margin-top:1px; border-left:5px solid #2E3333; font-weight:100; font-size:20px; ">  <k style="position:relative; padding-left:15px; "> PENvironment - მწერლები დედაქალაქზე </k>  </b> </div> </h2> 
   
   
      <div style="position:relative; padding-bottom:50px; font-size:14px; padding-top:px; width:350px;" align="left">  <strong>  </strong> PENvironment თავს უყრის ყოველკვირეულ ბლოგებს დედაქალაქში არსებულ გარემოზე, მივიწყებულ ისტორიებზე, წარსულისა და აწმყოს გააზრებაზე...  <br><br>
...
<br><br>
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name where kategory='penvironment' AND eng_geo='Geo' OR tags LIKE '%,penvironment%' ";
	$total_pages = mysqli_fetch_array(mysqli_query($conn, $query));
	$total_pages = $total_pages['num'];
	
	/* Setup vars for query. */
	$targetpage = "index.php?do=penvironment"; 	//your file name  (the name of this file)
	...
	$sql = "SELECT * FROM $tbl_name where kategory='penvironment' AND eng_geo='Geo' OR tags LIKE '%,penvironment' order by news_date desc LIMIT $start, $limit";
