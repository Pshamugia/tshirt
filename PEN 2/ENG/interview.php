...
<tr>
<td valign="top"> 
<h2 style="position:relative; top:12px; left:76px;"> <div style="position:relative; margin-left:25px; height:20px; margin-top:1px; border-left:5px solid #2E3333; font-weight:100; font-size:20px;">  <k style="position:relative; padding-left:15px;"> Interview </k>  </b> </div> </h2>
<div class="contactFrm" style="position:relative; padding-top:25px; padding-left:25px;">
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name where kategory='ინტერვიუ' AND eng_geo='Eng'";
	$total_pages = mysql_fetch_array(mysql_query($query));
	$total_pages = $total_pages['num'];
	
	/* Setup vars for query. */
	$targetpage = "index.php?do=interview"; 	//your file name  (the name of this file)
	...
	$sql = "SELECT * FROM $tbl_name where kategory='ინტერვიუ' AND eng_geo='Eng' order by id desc LIMIT $start, $limit";
