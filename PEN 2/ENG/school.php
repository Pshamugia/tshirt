<table style="position:relative; left:-45px; top:30px;" width="1000px" align="center">
   <tr>
   <td valign="top"> 
   <h2 style="position:relative; top:-50px; left:-15px; padding-bottom:15px;"> <div style="position:relative; margin-left:15px; height:20px; margin-top:1px; border-left:5px solid #2E3333; font-weight:100; font-size:20px;">  <k style="position:relative; padding-left:15px;"> მწერლები სკოლებში </k>  </b> </div> </h2>  </td> <td valign="top"> </td>
   <tr> 
    <?
