...
<td valign="top"> 
 <h2 style="position:relative; top:10px;  padding-bottom:15px; "> <div style="position:relative;height:20px; margin-top:1px; border-left:5px solid #2E3333; font-weight:100; font-size:20px; ">  <k style="position:relative; padding-left:15px; "> მწერლები სიძულვილის ენის წინააღმდეგ </k>  </b> </div> </h2> 
   
   
      <div style="position:relative; padding-bottom:50px; font-size:14px; padding-top:px; width:350px;" align="left"> ვებპლატფორმა<strong> Hatecontrol.ge </strong>  საქართველოს პენცენტრის პროექტია. მისი მიზანია აამაღლოს სამოქალაქო ცნობიერება სიძულვილის ენასთან დაკავშირებით და შესაბამისად, შეამციროს მისი გავლენა საზოგადოების სხვადასხვა სფეროზე. პროექტის პარტნიორია გერმანიის მარშალის ფონდი.
<br><br>
  </div>    
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name where kategory='სიძულვილის ენა' AND eng_geo='Geo'";
	...
	$sql = "SELECT * FROM $tbl_name where kategory='სიძულვილის ენა' AND eng_geo='Geo' order by news_date desc LIMIT $start, $limit";
