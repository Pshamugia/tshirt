...
<div style="position:relative; margin-left:7px; height:20px; margin-bottom: 25px; margin-top:15px; font-weight:bold;"> <a style="position:relative; font-size:18px; margin-left:10px; top:-3px; color: #fc3f00 ">  <ch><i class="fas fa-align-center"></i> რეცენზია </ch> </a> </b> </div>  
 ...
 <div class="row">  
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name where kategory='რეცენზია'";
	$total_pages = mysqli_fetch_array(mysqli_query($conn, $query));
	$total_pages = $total_pages['num'];
	
	/* Setup vars for query. */
	$targetpage = "index.php?do=recenzia"; 	//your file name  (the name of this file)
	...
	$sql = "SELECT * FROM $tbl_name where kategory='რეცენზია' order by id desc LIMIT $start, $limit";
