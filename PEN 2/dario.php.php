...
<tr>
<td valign="top"> 
<h2 style="position:relative; top:12px; left:76px;"> <div style="position:relative; margin-left:25px; height:20px; margin-top:1px; border-left:5px solid #2E3333; font-weight:100; font-size:20px;">  <k style="position:relative; padding-left:15px;"> დიალოგი ცენზურაზე </k>  </b> </div> </h2>
<div class="contactFrm" style="position:relative; padding-top:25px; padding-left:25px;">
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name where kategory='დარიო რადიო' AND eng_geo='Geo'";
	$total_pages = mysql_fetch_array(mysql_query($query));
	$total_pages = $total_pages['num'];
	
	/* Setup vars for query. */
	$targetpage = "index.php?do=dario"; 	//your file name  (the name of this file)
	...
	$sql = "SELECT * FROM $tbl_name where kategory='დარიო რადიო' AND eng_geo='Geo' order by id desc LIMIT $start, $limit";
...
<div align="left"> 
<a href="index.php?do=full&id=<? echo $b['id'];?>"><img src="<? echo $b['upload'];?>" alt="" id="im55" class="cover55" style="position:relative; padding-right:10px; padding-top:13px; padding-bottom:8px;" align="left"  /> </a></div> 

<div align="left" id="linkebi"> <a href="index.php?do=full&id=<? echo $b['id'];?>" style="position:relative; font-size:14px;"> <?  
$avt=mysql_query("select * from  avtorebi where id='$b[avtori]'");
$avts_id=mysql_fetch_array($avt); ?> <k>
