...
<div class="contactFrm" style="position:relative; padding-top:25px; padding-left:25px;">
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name where kategory='ცენზურა' AND eng_geo='Geo'";
	$total_pages = mysql_fetch_array(mysql_query($query));
	$total_pages = $total_pages['num'];
	
	/* Setup vars for query. */
	$targetpage = "index.php?do=censorship"; 	//your file name  (the name of this file)
	...
	$sql = "SELECT * FROM $tbl_name where kategory='ცენზურა' AND eng_geo='Geo' order by id desc LIMIT $start, $limit";
